...
# make sure your language_model is 'GPT-2', if not edit on predict.py
...
print(generated_caption_coco_2)
...
#     # print(f'generated 1 : {generated_caption_coco_beam}')
#     # print(f'generated 2 : {generated_caption_coco_2}')
...
# with open(os.path.join(output_file, f'clipcap_2_{args.language_model}.json'), 'w') as fp:
#     json.dump(data_coco_2, fp)
# with open(os.path.join(output_file, f'clipcap_beam_{args.language_model}.json'), 'w') as fp:
