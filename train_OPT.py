...
def main():
    ...
    parser.add_argument('--language_model', type=str, default='gpt2', help='gpt2/opt')
    parser.add_argument('--parallel_num', type=int, default=6, help='0<n<12')
    args = parser.parse_args()
    ...
    if args.only_prefix:
        model = ClipCaptionPrefix(args, prefix_size=prefix_dim)
        print("Train only prefix")
    else:
        model = ClipCaptionModel(args, prefix_size=prefix_dim)
